...
**UPD: Протестировано на нескольких ПК; работает как с проводным, так и с Bluetooth подключением.**
**При подключении через Bluetooth может наблюдаться значительная задержка.**
